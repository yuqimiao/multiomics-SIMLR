"umkl_u" = function( D, beta = NA, u = 20 ) {
...
"SIMLR_multi_u" = function(D_Kernels, c, no.dim = NA, k = 10, if.impute = FALSE, normalize = FALSE, u = 20, cores.ratio = 1 ) {
