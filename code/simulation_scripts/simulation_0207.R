...
save(res_gl, file = paste("simu_0207/res_gl",n, ".Rdata", sep = ""))
...
save(res_cim, file = paste("simu_0207/res_cim",n, ".Rdata", sep = ""))
...
save(eva_table, file = paste("eva_table", n,".Rdata", sep = ""))
