...
for(m in 1:length(par)){
  ...
  ## SIMLR_generated_weight
  # W_sim = SIMLR_multi_generated_weight(data_list = data_list, c = 4)
  ...
  eva_table_nmi = tibble(scenario = scenario_name[m],
                         ...
                         # nmi_sim = igraph::compare(truth, cluster_sim, method = "nmi")
  )
  eva_table_rand = tibble(scenario = scenario_name[m],
                          ...
                          # rand_sim = igraph::compare(truth, cluster_sim, method = "rand")
  )
...
#
save(res,
     file = paste("simu_1229/sim_res",n,".Rdata", sep = ""))
