...
data_list = list(scen7,scen8)
names(data_list) = c('scen7','scen8')
...
load("simu_0214/best_tuned_par_scen78.Rdata")
...
save(res_gl, file = paste("simu_0214/res_gl",n, ".Rdata", sep = ""))
...
save(res_cim, file = paste("simu_0214/res_cim",n, ".Rdata", sep = ""))
...
save(eva_table, file = paste("simu_0214/eva_table", n,".Rdata", sep = ""))
