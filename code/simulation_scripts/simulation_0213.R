...
load(file = "simu_0213/mk_list.Rdata")
load(file = "simu_0213/par.Rdata")
...
save(res, file = paste("simu_0213/res_",names(par)[n], ".Rdata", sep = ""))
save(nmi_ls, file = paste("simu_0213/nmi_",names(par)[n], ".Rdata", sep = ""))
